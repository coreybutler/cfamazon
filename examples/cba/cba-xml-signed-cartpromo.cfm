<cfscript>
	...
	//Add a cart-level promotion
	cart.addPromotion("15off","$15 off your entire purchase!",15,true);
</cfscript>
<html>
	<head>
		...
		<title>XML Signed Cart w/ Promotion Example</title>
	</head>
	<body>
		<em>$15 OFF ENTIRE ORDER!</em>
